      ...
      >
        ...
        >
          {/*
            ...
            `bg-bg` to match the framing the shell puts around this —
            reframe the page on a different surface and this wants
            overriding with it. The transition is not decoration either:
            without it the shield snaps between themes while the page
            behind it is still crossfading, which flashes a hard box for
            the length of a theme switch. 300ms on the default curve is
            what `LifelineShell` fades on, so the two move as one.
          */}
          <div
            ref={labelsRef}
            className="lifeline-labels shrink-0 bg-bg transition-colors duration-300 will-change-transform"
          ...
          <div className="relative">
            ...
            >
              <div
                className={cn(
                  "h-px w-full border-t border-dashed border-divider transition-colors duration-300",
